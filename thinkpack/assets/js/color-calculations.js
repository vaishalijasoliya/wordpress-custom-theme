 ...
 * @return {Object} - this
 */
function _thinkpackColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_thinkpackColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_thinkpackColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_thinkpackColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _thinkpackColor object.
 *
 * @since Think Pack 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function thinkpackColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _thinkpackColor( backgroundColor, accentHue );
