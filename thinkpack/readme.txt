...
Think Pack WordPress Theme, Copyright 2019-2020 WordPress.org
Think Pack is distributed under the terms of the GNU GPL.
...
Think Pack is derived from the Chaplin Theme, Copyright 2019 Anders Norén
Chaplin Theme is distributed under the terms of the GNU GPL version 2.0

Think Pack bundles the following third-party resources:
...
Bespoke Icons Created For Think Pack
License: Creative Commons Zero (CC0), https://creativecommons.org/publicdomain/zero/1.0/
...
- thinkpack_SVG_Icons
- thinkpack_the_theme_svg()
- thinkpack_get_theme_svg()
- thinkpack_nav_menu_social_icons()
